...
5. `docs/CHANGELOG.md` — полная история изменений (v1–v23)
6. `docs/ERRORS.md` — паттерны ошибок (не допускать повторно)

## Текущее состояние проекта (v23)
...
### Блок «Сканер инструментов» (v23) — отдельная страница scanner.html
...
**Текущие иконки (14 из 20):**
- С цветными PNG (оба слоя): market, strategy, marketer, competitors, unit-economics, swot, funnel, jtbd, 4p, target-audience, ad-channels, cjm, hadi, abcdx
- **Не хватает 6:** cross-sale.png, product.png, interview.png, rop.png, cvp.png, contractor.png
...
- Интеграция оставшихся 6 цветных иконок (cross-sale, product, interview, rop, cvp, contractor)
- Доработка/улучшение визуала сканера
